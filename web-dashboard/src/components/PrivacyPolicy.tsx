                ...
                <div className="overflow-y-auto p-6 space-y-6 text-gray-600 text-xs leading-relaxed font-sans text-justify">
                    ...
                    <section>
                        ...
                        <ul className="list-disc pl-4 space-y-1">
                            ...
                            <li>Bu politika, <a href="https://hanchat.com.tr/" target="_blank" rel="noreferrer" className="text-blue-600 hover:underline">https://hanchat.com.tr/</a> web sitesi ve ilgili hizmetler üzerinden toplanan verilerin işlenme esaslarını düzenler.</li>
